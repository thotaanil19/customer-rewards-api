...
class UtilTest {
	...
	void testCalculateRewards() {
		...
		List<RewardsConfiguration> rewardsConfigurations = buildRewardsConfigurationList();
	...
	@Test
	void testCalculateRewardsWithNoRewardsConfiguration() {
		// User will get 0 rewards if no rewards configurations found
		Assertions.assertEquals(0D, Util.calculateRewards(200D, null));
	}

	@Test
	void testCalculateRewardsWithPurchaseAmountZero() {
		// User will get 0 rewards if purchase amount is 0
		Assertions.assertEquals(0D, Util.calculateRewards(0D, buildRewardsConfigurationList()));
	}
	...
	/**
	 * Mock RewardsConfiguration list
	 * 
	 * @return List<RewardsConfiguration>
	 */
	private List<RewardsConfiguration> buildRewardsConfigurationList() {

		// Customer will get 2 Reward point if he/she buys 100 or more
		...
		// Customer will get 1 Reward point if he/she buys 50 or more
		...
		return Arrays.asList(rewardsConfiguration1, rewardsConfiguration2);
	}
